summon witch -58 13 150 {ActiveEffects:[{Id:14,Amplifier:0b,Duration:3,ShowParticles:0b}],CustomNameVisible:0b,Team:"enemy",PersistenceRequired:1b,CanPickUpLoot:0b,Health:30f,Tags:["forkill","clashmob","witchmob"],CustomName:'{"text":"Witch","color":"light_purple","italic":false}',Attributes:[{Name:generic.max_health,Base:30},{Name:generic.movement_speed,Base:0.3},{Name:generic.attack_damage,Base:0},{Name:zombie.spawn_reinforcements,Base:0}]}
...
scoreboard players add @s cr_witspawned 1