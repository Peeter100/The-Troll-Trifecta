execute if score @s cr_beeninbattle matches ..3 run scoreboard players set @s acttimer 600
# execute if score @s cr_beeninbattle matches ..3 run scoreboard players set @s cr_score 5000
execute if score @s cr_beeninbattle matches ..3 run scoreboard players set @s cr_score 5500
execute if score @s cr_beeninbattle matches 4.. run scoreboard players set @s acttimer 991
execute if score @s cr_beeninbattle matches 4.. run scoreboard players set @s cr_score 6000
...
# execute if score @s cr_beeninbattle matches 4.. run give @a[team=p] potion{display:{Name:'{"text":"Potion of Productivity","color":"gold","italic":false}'},CustomPotionEffects:[{Id:1,Amplifier:4b,Duration:200,ShowParticles:1b},{Id:5,Amplifier:1b,Duration:200,ShowParticles:1b},{Id:6,Amplifier:10b,Duration:1},{Id:11,Amplifier:1b,Duration:200,ShowParticles:1b}],CustomPotionColor:16711680} 1
execute if score @s cr_beeninbattle matches ..3 run give @a[team=p] gold_ingot{display:{Name:'{"text":"Snowball Ammo","color":"aqua","italic":false}'},CustomModelData:2} 1