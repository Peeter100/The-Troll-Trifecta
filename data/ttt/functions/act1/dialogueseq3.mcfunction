...
execute if score @s fnf_tailsstate matches 0 as @e[type=armor_stand,tag=tails] at @s run tp @s ~ ~ ~ facing 2 31 101
execute if score @s fnf_tailsstate matches 1 if score @s fnf_seentails matches ..4 as @e[type=armor_stand,tag=tailshead,limit=1] at @s run tp @s ~ ~ ~ facing 2 31 101
