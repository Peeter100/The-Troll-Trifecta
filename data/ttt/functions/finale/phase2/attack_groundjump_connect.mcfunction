...
execute positioned ^ ^ ^1.5 run summon creeper ~ 15 ~ {Silent:1b,Invulnerable:1b,Team:"enemy",Health:100f,Fuse:0,Tags:["forkill"],Attributes:[{Name:generic.max_health,Base:100}]}
tp 00000001-0000-0000-0000-000000000000 ~ 15 ~

kill @e[type=marker,tag=trollgeleaptrgt]
scoreboard players add @s f3_attackcombo 1
