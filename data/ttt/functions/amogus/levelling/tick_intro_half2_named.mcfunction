execute if score @s dialoguetime matches 2001 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"Every time you get a kill, I will be judging.","color":"#331E44"}]
...
execute if score @s dialoguetime matches 2070 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"The sneakier the kill,","color":"#331E44"}]
execute if score @s dialoguetime matches 2070 at @r[tag=amplayer] run playsound custom.amogus.text master @a ~ ~ ~ 1000 0.5
execute if score @s dialoguetime matches 2100 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"and the better getaway you'll have,","color":"#331E44"}]
...
execute if score @s dialoguetime matches 2140 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"the more ","color":"#331E44"},{"text":"Impostor Experience (IXP)","color":"red"},{"text":" you will gain.","color":"#331E44"}]

execute if score @s dialoguetime matches 2200 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"The more Impostor Experience,","color":"#331E44"}]
...
execute if score @s dialoguetime matches 2230 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"the easier I can make the game for you.","color":"#331E44"}]

execute if score @s dialoguetime matches 2300 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"Less crewmates, faster kill cooldown...","color":"#331E44"}]
...
execute if score @s dialoguetime matches 2350 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"I can do a lot!","color":"#331E44"}]

execute if score @s dialoguetime matches 2380 run tellraw @a [{"text":"<","color":"gray"},{"text":"Black","color":"#331E44"},{"text":"> "},{"text":"Show me what you're made of.","color":"#331E44"}]
