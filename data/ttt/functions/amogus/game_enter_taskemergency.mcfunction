...
execute at @p[tag=amplayer] run playsound custom.amogus.emergency_meeting master @a ~ ~ ~ 1000
...
title @a subtitle [{"text":"Called by ","color":"white"},{"text":"The King","color":"yellow"}]
