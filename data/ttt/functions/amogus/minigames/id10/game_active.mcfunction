...
execute if entity @s[scores={am_gamescore6=70..}] run scoreboard players remove @s am_gamescore2 1
execute if entity @s[scores={am_gamescore6=70..}] run scoreboard players remove @s am_gamescore6 70

execute if entity @s[scores={am_gametimer=2000}] run function ttt:amogus/minigames/id10/move

execute if score @s am_gamescore1 matches 100.. run scoreboard players add @e[type=armor_stand,tag=foxy,limit=1] npcbodytp 1
...
execute if score @s am_gamescore1 matches 200.. run scoreboard players add @e[type=armor_stand,tag=freddy,scores={npcbodytp=..1999},limit=1] npcbodytp 1
...
title @a actionbar [{"text":"Power left: ","color":"white","italic":false},{"score":{"name":"@s","objective":"am_gamescore2"}},{"text":"%, "},{"score":{"name":"@s","objective":"am_gamescore1"},"color":"green"},{"text":"/400 Commands","color":"green"}]

execute if score @s am_gamescore2 matches ..0 run function ttt:amogus/minigames/id10/disable_fnaf_powerout
execute if score @s am_gamescore1 matches 400.. if score @s am_gamescore2 matches 1.. run function ttt:amogus/minigames/id10/linux_complete
