spreadplayers ~ ~ 10 30 under 17 false @e[type=armor_stand,tag=tptrollge]
...
execute at @e[type=armor_stand,tag=tptrollge] if entity @a[tag=amplayer,distance=0..25] run scoreboard players set @s am_gamescore3 0
