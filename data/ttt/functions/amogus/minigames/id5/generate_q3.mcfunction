...
scoreboard players set @s am_gamescore3 16
...
execute if entity @s[scores={am_gamescore5=6..,am_gamescore4=1..}] run scoreboard players operation @s am_gamescore5 -= @s am_gamescore4
execute if entity @s[scores={am_gamescore5=6..,am_gamescore4=..-1}] run scoreboard players operation @s am_gamescore5 += @s am_gamescore4
execute if entity @s[scores={am_gamescore5=..-7,am_gamescore4=1..}] run scoreboard players operation @s am_gamescore5 += @s am_gamescore4
execute if entity @s[scores={am_gamescore5=..-7,am_gamescore4=..-1}] run scoreboard players operation @s am_gamescore5 -= @s am_gamescore4
execute if entity @s[scores={am_gamescore5=1}] run scoreboard players operation @s am_gamescore5 += @s am_gamescore4
scoreboard players operation @s am_gamescore3 *= @s am_gamescore5
scoreboard players operation @s am_gamescore2 += @s am_gamescore3

execute as @r[tag=amplayer] at @s run playsound custom.act3.bald.baldi_math_stage3 master @a ~ ~ ~ 1000
tellraw @a [{"text":"<","color":"white"},{"text":"Baldi","color":"green"},{"text":"> "},{"text":"Problem 3!","color":"green"},{"text":"\nWhat is the answer to the following equation?","color":"light_purple"}]
scoreboard players enable @a[tag=amplayer] Baldi_Answer

execute if entity @s[scores={am_gamescore5=1..}] run tellraw @a [{"score":{"name":"@s","objective":"am_gamescore4"},"color":"yellow"},{"text":" + 2\uE007 * "},{"score":{"name":"@s","objective":"am_gamescore5"}},{"text":" = ??"}]
...
scoreboard players set @s am_gamescore1 5