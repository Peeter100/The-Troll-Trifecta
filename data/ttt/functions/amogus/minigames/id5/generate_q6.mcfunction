scoreboard players set @s am_gamescore2 2
...
#execute as @r[tag=amplayer] at @s run playsound custom.act3.bald.baldi_math_stage6 master @a ~ ~ ~ 1000
tellraw @a [{"text":"<","color":"white"},{"text":"Baldi","color":"green"},{"text":"> "},{"text":"Problem 6!","color":"green"},{"text":"\nFind all possible values of x.","color":"light_purple"}]
scoreboard players enable @a[tag=amplayer] Baldi_Answer

tellraw @a [{"text":"x\uE005+4x-12 = 0","color":"yellow"}]
...
scoreboard players set @s am_gamescore1 11